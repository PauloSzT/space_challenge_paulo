...
1. Clone the repo
   ...
   git clone https://github.com/PauloSzT/space_challenge_paulo.git

2. Open IntelliJ IDEA CE

   cd ...~/space_challenge_paulo
...
Feel free to check the [issues page](https://github.com/PauloSzT/space_challenge_paulo/issues).
